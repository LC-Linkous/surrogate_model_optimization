...
try: # for outside func calls, program calls
    ...
    from optimizers.multi_glods.multiglods_helpers import logical_index_1d
    from optimizers.multi_glods.multiglods_helpers import logical_index_h2d
    from optimizers.multi_glods.multiglods_helpers import logical_set_val
    from optimizers.multi_glods.multiglods_alg import merge
